...
#define LCD_PEN_READ  HAL_GPIO_ReadPin(T_IRQ_GPIO_Port, T_IRQ_Pin)
#define LCD_DOUT_READ  HAL_GPIO_ReadPin(T_DO_GPIO_Port, T_DO_Pin)
#define	LCD_TDIN_SET  HAL_GPIO_WritePin(T_DIN_GPIO_Port, T_DIN_Pin, GPIO_PIN_SET)
#define	LCD_TDIN_CLR  HAL_GPIO_WritePin(T_DIN_GPIO_Port, T_DIN_Pin, GPIO_PIN_RESET)
#define	LCD_TCLK_SET  HAL_GPIO_WritePin(T_CLK_GPIO_Port, T_CLK_Pin, GPIO_PIN_SET)
#define	LCD_TCLK_CLR  HAL_GPIO_WritePin(T_CLK_GPIO_Port, T_CLK_Pin, GPIO_PIN_RESET)
#define	LCD_TCS_SET  HAL_GPIO_WritePin(T_CS_GPIO_Port, T_CS_Pin, GPIO_PIN_SET)
#define	LCD_TCS_CLR  HAL_GPIO_WritePin(T_CS_GPIO_Port, T_CS_Pin, GPIO_PIN_RESET)
